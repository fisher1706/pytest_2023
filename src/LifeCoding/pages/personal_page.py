import allure
from src.LifeCoding.base.base_page import BasePage
from src.LifeCoding.config.links import Links
...
class PersonalPage(BasePage):
    ...
    def __init__(self, driver):
        ...
        self.PAGE_URL = Links.PERSONAL_PAGE
        self.FIRST_NAME_FIELD = ("xpath", "//input[@name='firstName']")
        self.SAVE_BUTTON = ("xpath", "(//button[@type='submit'])[1]")
        self.SPINNER = ("xpath", "//div[@class='oxd-loading-spinner']")
        self.name = None
